...
// splice는 삭제한 번호들을 다시 배열로 저장시킬 수 있다
let delFood = foods.splice(1, 2);
console.log(foods);
console.log(delFood);
...
// deleteCount를 0으로 설정하면 인덱스를 하나도 삭제하지 않고 중간에 요소 추가 가능
foods.splice(2, 0, '파스타');
console.log(foods);

// deleteCount를 설정하지 않으면 3번 인덱스부터 끝까지 전체 삭제됨
foods.splice(3);
console.log(foods);
